        ...
        <div className='relative size-full'>
            ...
            <div className='relative z-10 flex size-full flex-col justify-between p-5 text-blue-50'>
                <div>
                    ...
                    {description && (
                        <p className='mt-3 max-w-64 text-x5'>{description}</p>
                    )}
                </div>
            </div>
        </div>
                ...
                <div className='grid h-[135vh] grid-cols-2 grid-rows-3 gap-7'>
                    <BentoTilt className='bento-tilt_1 row-span-1 md:col-span-1 md:row-span-2'>
                        <BentoCard
                            ...
                            title={<>zig<b>m</b>a</>}
                            description="An anime and gaming-inspired NFT cllection - the IP primed for expansion."
                        />
                    </BentoTilt>
                    ...
                    <BentoTilt className='bento-tilt_1 me-14 md:col-span-1 md:me-0'>
                        <BentoCard
                            ...
                            title={<>az<b>u</b>l</>}
                            description="A cross-world AI Agent - elevating yout gameplay to be more fun and productive."
                        />
                    </BentoTilt>

                    <div className='bento-tilt_2'>
                        <div className='flex size-full flex-col justify-between bg-violet-300 p-5'>
                            <h1 className='bento-title special-font max-2-64 text-black'>M<b>o</b>re Co<b>m</b>ing S<b>o</b>on!</h1>
